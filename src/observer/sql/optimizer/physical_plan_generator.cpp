...
RC PhysicalPlanGenerator::create_plan(UpdateLogicalOperator &logical_oper, unique_ptr<PhysicalOperator> &oper)
{
  ...
  oper = unique_ptr<UpdatePhysicalOperator>(
      new UpdatePhysicalOperator(logical_oper.table(), logical_oper.attribute_name(), logical_oper.value()));
